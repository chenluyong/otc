...
public class Ed25519Field {
     ...
     * P: 2^255 - 19
     */
    public static final BigInteger P = new BigInteger(Hex.fromHexString("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffed"));
     ...
     * I ^ 2 = -1
     */
    public static final Ed25519FieldElement I = new Ed25519EncodedFieldElement(Hex.fromHexString("b0a00e4a271beec478e42fad0618432fa7d7fb3d99004d2b0bdfc14f8024832b")).decode();
    ...
    private static Ed25519FieldElement getD() {
        ...
        return new Ed25519EncodedFieldElement(BigIntUtil.bigIntegerToBytesLS(d, 32)).decode();
    }
}
