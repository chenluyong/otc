...
public class Ed25519EncodedFieldElement {
	...
	public boolean isNonZero() {
		return 0 == ByteArrayData.isEqualConstantTime(this.values, this.zero);
	}
	...
	public boolean equals(final Object obj) {
		...
		return 1 == ByteArrayData.isEqualConstantTime(this.values, encoded.values);
	}

	@Override
	public String toString() {
		return Hex.toHexString(this.values);
	}
}
