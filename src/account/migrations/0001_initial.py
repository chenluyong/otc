    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_email_confirmed', models.BooleanField(default=False, verbose_name='是否验证邮箱')),
                ('bio', models.TextField(null=True, verbose_name='个人简介')),
                ('avatar_url', models.FileField(default='/avatar/default_avatar.jpg', upload_to='avatar/', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='account_providers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
